...
public class VerificarPinCliente extends javax.swing.JFrame {
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificarPinCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerificarPinCliente(cliente, parqueo,pin).setVisible(true);
            }
        });
    }
