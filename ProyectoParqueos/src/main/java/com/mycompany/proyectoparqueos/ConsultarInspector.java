...
public class ConsultarInspector extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTerminal.setFont(new java.awt.Font("Segoe UI Variable", 0, 18)); // NOI18N
        lblTerminal.setForeground(new java.awt.Color(255, 255, 255));
        lblTerminal.setText("Terminal de inspección:");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblTerminal, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarInspector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarInspector(inspector, parqueo).setVisible(true);
            }
        });
    }
    ...
    public void mostrarInfoInspector(){
        ...
        lblCorreo.setText("Correo electrónico: "+inspector.getCorreo());
        lblTelefono.setText("Número de teléfono: "+ String.valueOf(inspector.getTelefono()));
        lblIdentificacion.setText("Identificacion de Usuario: "+ inspector.getIdentificacionUsuario());
        lblDireccion.setText("Dirección física: " + inspector.getDireccionFisica());
        ...
        lblTerminal.setText("Terminal de inspección: "+ inspector.getCodigoTerminal());
